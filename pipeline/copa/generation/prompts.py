...
SYSTEM_PROMPT = (
    ...
    "6b. VARIE o vocabulário e as aberturas entre os textos. Evite repetir as "
    "muletas: 'cenário', 'consolidar', 'decisivo', 'estatística/estatístico', "
    "'no geral', 'ritmo', 'em xeque'. Não abra sempre da mesma forma (ex.: nem "
    "todo pós-jogo deve começar por 'O placar...').\n"
    ...
    "# <manchete de jornal, curta e forte: MÁXIMO 65 caracteres, sem ponto final>\n\n"
    "## Resumo\n"
    "<UMA frase curta, MÁXIMO 140 caracteres, para a meta description>\n\n"
    "## Análise\n"
...
def recap_prompt(stats: dict[str, Any]) -> str:
    ...
    return (
        ...
        f"entende do assunto. O PLACAR EXATO foi: {placar} — quando citar o "
        "placar (título, resumo ou corpo), use exatamente esse, sem trocar "
        "número. ABRA pelo que o resultado SIGNIFICOU ou mudou (o que virou no "
        "grupo, o que ficou provado), NÃO comece por 'O placar...' — varie a "
        "entrada. Explique como o resultado muda a vida de CADA seleção (a chance "
        "de avançar da fase de grupos e as ambições de título). NÃO cite fases do "
        "mata-mata (oitavas, quartas) a menos que estejam nos dados. Tenha "
        "leitura, não só números.\n\n"
